...
export default function Header({ title, subtitle, actions }: HeaderProps) {
  ...
  return (
    <>
      ...
      <header className="h-14 z-[2000] bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 flex items-center px-5 gap-4 flex-shrink-0 transition-colors relative">
